...
public class PERS2 extends JFrame {
	...
	public PERS2() {
		...
		lblNewLabel.setBounds(658, 32, 450, 50);
		...
		btnNewButton.setBounds(92, 36, 70, 31);
		contentPane.add(btnNewButton);
		
		JPanel panel = new JPanel();
		panel.setBackground(new Color(245, 255, 250));
		panel.setBounds(374, 189, 796, 571);
			...
			public void actionPerformed(ActionEvent e) {
				soldier_id=textField.getText();
				 ...
				 try {
					 ...
					 String query="Delete from personal where soldier_id='"+textField.getText()+"'  " ;
		...
		btnNewButton_1.setBounds(76, 514, 141, 31);
		...
		btnNewButton_2.setBounds(358, 514, 126, 31);
				...
				gender.trim().length()==0		||	 dob==null ||dob.trim().length()==0|| blood_group==null ||blood_group.trim().length()==0|| date_of_join==null ||
		 ...
		 else
				 {
					 try {
						 Connection connection=DriverManager.getConnection(url,user,password);
						 System.out.println("Connected to database");
						 String query="Update personal set soldier_id='"+textField.getText()+"',s_name='"+textField_1.getText()+"', gender='"+textField_2.getText()+"', dob='"+textField_3.getText()+"',blood_group='"+textField_4.getText()+"',date_of_join='"+textField_5.getText()+"',regi_name='"+textField_6.getText()+"' where soldier_id='"+textField.getText()+"'   " ;
						 PreparedStatement preparedStmt=connection.prepareStatement(query);
		...
		btnNewButton_1_1.setBounds(592, 514, 141, 31);
		panel.add(btnNewButton_1_1);
		
		textField_2 = new JTextField();
		textField_2.setBounds(346, 178, 303, 31);
		...
		btnNewButton_4.setBounds(1227, 107, 142, 31);
		...
		btnHome.setBounds(693, 110, 89, 31);
