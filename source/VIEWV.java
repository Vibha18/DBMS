...
public class VIEWV {
	...
	private void initialize() {
		...
		String[] columns = new String[] {"Soldier_id","Weapon_id","Weapon_name"};
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String query="select count(*)" + "from WEAPON";
		            ...
		            String sql = "select sr_id,wp_id,wp_name " + "from WEAPON";
