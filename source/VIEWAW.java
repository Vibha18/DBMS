...
public class VIEWAW {
	...
	private void initialize() {
		...
		String[] columns = new String[] {"Soldier_id","Award_name"};
		...
		btnView.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String query="select count(*)" + "from AWARDS";
		            ...
		            String sql = "select sd_id,award_name " + "from AWARDS";
